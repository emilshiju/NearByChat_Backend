...
export const accessToken = (userName: string, email: string, id: ObjectId) => {
  const secretOrPrivateKey: Secret =
    process.env.ACCESS_TOKEN_SECRET || "ejiofheoihfoiehofheiofhejrhfoh";
...
export const verifyRefreshToken = (
  ...
  const secret: Secret =
    process.env.REFRESH_TOKEN_SECRET || "SUFHSIUFHISDHFSHFKWEHFUEWH";
...
export const verifyAccesToken = (
  ...
  try {
    ...
    const secretOrPrivateKey: AccessTokenSecret =
      process.env.ACCESS_TOKEN_SECRET || "ejiofheoihfoiehofheiofhejrhfoh";
