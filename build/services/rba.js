...
var userRepo = userRoute_1.container.get(appConst_1.INTERFACE_TYPE.UserRepository);
var checkRole = function (roles) { return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var decoded, ans;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, userRepo.RoleBasedAuthentication(decoded.id)];
            case 1:
                ans = _a.sent();
                console.log(ans);
